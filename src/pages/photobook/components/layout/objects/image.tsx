...
import { SlideObject } from 'interfaces'
...
const Image: React.FC<Props> = ({
  ...
  const borderWidth = object?.props?.frameStyle?.borderWidth
  ...
  return (
    ...
    >
      ...
      <div className="background" style={placeholderStyle} />
      <img
        ref={imageRef}
        alt="object"
        className="image"
      ...
      />
      <PlusSquareOutlined className="plus" style={{ display: imageStyle.display === 'none' ? 'block' : 'none' }} />
      {imageUrl && willBlur && (
